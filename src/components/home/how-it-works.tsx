    ...
    <section id="how-it-works" className="py-20 bg-[var(--surface)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-1/2 start-1/3 end-1/3 h-0.5 bg-gradient-to-r from-[var(--zkawi-purple)]/30 via-amber-400/30 to-emerald-400/30 -translate-y-1/2" />
