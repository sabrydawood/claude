...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    AdminService.getLessons()
      ...
      .catch((err) => {
        if (err instanceof HttpClientError && err.status === 403)
          setForbidden(true);
      })
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-5xl flex flex-col gap-6">
        ...
        {saveOk && (
          <div
            className="flex items-center gap-2 text-sm text-green-600 px-3 py-2 rounded-lg"
