...
**التاريخ:** 2026-05-16
**الحالة:** ⏳ معلق — ينتظر موافقة Sabry
...
**ما يحتاج موافقة Sabry:**
1. هل تتبنى فكرة "world map" كـ navigation بدل قائمة الدروس؟
2. هل الـ Hybrid (3D + HTML) هو الاتجاه المختار؟
3. هل نبدأ تصميم الـ UI الجديد الآن أم بعد Phase 1؟

---

## سجل القرارات المعلقة

| الكود | الموضوع | المطلوب |
|-------|---------|---------|
| D-008 | UI Direction | موافقة على world map + hybrid 3D |
