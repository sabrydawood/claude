...
export default function SettingsClient({
  ...
  const inputClass =
    "w-full rounded-lg px-3 py-2 text-sm outline-none transition-colors focus:border-[var(--zkawi-pink)]";
  const inputStyle = {
    background: "var(--bg)",
    color: "var(--text)",
    ...
    >
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-2xl flex flex-col gap-6">
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              <Settings size={18} style={{ color: "var(--zkawi-pink)" }} />
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              <Lock size={18} style={{ color: "var(--zkawi-pink)" }} />
              <h2 className="font-semibold" style={{ color: "var(--text)" }}>
                {t("password.title")}
              </h2>
            </div>
