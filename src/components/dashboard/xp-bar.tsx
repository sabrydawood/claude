...
export default function XpBar({ totalXp, showDetails = true }: XpBarProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-pink-600 to-indigo-600 rounded-3xl p-6 text-white">
      {/* Level badge */}
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-xs text-pink-200 font-medium">
          <span>{currentXp} XP</span>
          <span>
            {xpToNext} XP {t("xpToNext")}
          </span>
        </div>
        ...
        <div className="text-xs text-pink-200 text-center">
